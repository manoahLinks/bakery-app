...
const Sidebar = () => {
    ...
    const menus = [
        ...
        {id:2, title:"Account", src:"user", gap: true},
        {id:3, title:"My Tasks", src:"calendar"},
        {id:4, title:"Analytics", src:"analytics", gap: true},
        {id:5, title:"Setting", src:"setting"}
    ]

    return ( 

        <div className={`${open ? "w-72" : "w-20" } pt-8 h-screen bg-gray-200 duration-300 relative hidden md:block`}>
