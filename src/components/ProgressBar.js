const ProgressBar = () => {
    return ( 
        <div className="flex flex-col justify-around p-5 bg-white rounded shadow-lg">
            <div className="text-sm font-semibold p-3">Monthly Progress</div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input min={0} max={100} step={10} value={72} className="appearance-none bg-sky-500" type="range" name="" id="" />
            </div>
